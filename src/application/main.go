...
func processMessage(session Session) {
	...
	*/
	message := fmt.Sprintf("Autogenerated: There are %d first vaccine doses available of %s at %s on %s", session.AvailableCapacityDose1, session.Vaccine, session.Name, session.Date)
